...
%   limits, and C2 continuity are checked from the Bezier control points.
    ...
    % ---------------------------------------------------------------------
    % Input and audit-contract validation
    % ---------------------------------------------------------------------
    if nargin < 3
        checkGoalHold = true;
    end
    ...
    % ---------------------------------------------------------------------
    % Analytic kinematic and C2 certification
    % ---------------------------------------------------------------------
    ...
    % ---------------------------------------------------------------------
    % Static and moving-obstacle clearance certification
    % ---------------------------------------------------------------------
    ...
    % ---------------------------------------------------------------------
    % Final stationary hold certification
    % ---------------------------------------------------------------------
...
% =========================================================================
% Audit schema and analytic kinematics
% =========================================================================
function audit = makeAudit
    % Audit contract: pass/fail flags, observed and certified clearance,
    % kinematic extrema, and precise failure location/type diagnostics.
    audit = struct( ...
        'collisionFree',true, ...
        'holdSafe',true, ...
...
% =========================================================================
% Dynamic obstacle intervals and contour correspondence
% =========================================================================
...
% =========================================================================
% Conservative Bezier-versus-obstacle certification
% =========================================================================
function [safe,observedDistance,certifiedDistance] = ...
...
function [safe,observedDistance,certifiedDistance] = ...
    ...
    % The midpoint distance minus half the combined curve/obstacle motion
    % is a conservative clearance lower bound for this parameter interval.
    % Recursive subdivision tightens the bound. Reaching maxDepth without
    % proving clearance fails closed rather than accepting an uncertain arc.
...
% =========================================================================
% Bezier subdivision and obstacle/topology utilities
% =========================================================================
...
% =========================================================================
% Option access and audit reporting
% =========================================================================
