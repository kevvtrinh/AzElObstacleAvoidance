...
%   This function remains the conservative polyline auditor; analytic C2
%   commands are delegated to AZEL.AUDIT.AUDITAZELTRAJECTORY.

    % Audit contract mirrors the core clearance/failure fields produced by
    % the analytic auditor so callers can consume either result uniformly.
    audit = struct( ...
        'collisionFree',true, ...
        'holdSafe',true, ...
    ...
    % ---------------------------------------------------------------------
    % Dispatch analytic trajectories, then validate raw path samples
    % ---------------------------------------------------------------------
    ...
    if isfield(result,'trajectory') && isstruct(result.trajectory) && ...
        ...
        audit = azel.audit.auditAzElTrajectory( ...
            scenario,result.trajectory,true);
        return
    end
    ...
    % ---------------------------------------------------------------------
    % Sample and continuous-segment clearance checks
    % ---------------------------------------------------------------------
...
% =========================================================================
% Goal hold and path-to-frame mapping
% =========================================================================
...
% =========================================================================
% Moving-obstacle correspondence and swept intervals
% =========================================================================
...
% =========================================================================
% Contour parsing and continuous geometry primitives
% =========================================================================
